function varargout = main_YI2(varargin)
...
% MAIN_YI3 MATLAB code for main_YI3.fig
%      MAIN_YI3, by itself, creates a new MAIN_YI3 or raises the existing
%      singleton*.
%
%      H = MAIN_YI3 returns the handle to a new MAIN_YI3 or the handle to
%      the existing singleton*.
%
%      MAIN_YI3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAIN_YI3.M with the given input arguments.
%
%      MAIN_YI3('Property','Value',...) creates a new MAIN_YI3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before main_YI3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to main_YI3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help main_YI3

% Last Modified by GUIDE v2.5 07-Feb-2017 10:08:03
...
% UIWAIT makes main_YI3 wait for user response (see UIRESUME)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Unforunately lots of redundant code until I can work out a more optimal
% solution.
contents=get(hObject,'Value');
%dur = str2double(get(handles.pulse_duration,'String'));
%enr = str2double(get(handles.pulse_energy,'String'));
...
% mean_T = (-1/alpha)*(exp(-alpha*Zr)-1)/Zr;
switch contents
    case 1 % Argon
